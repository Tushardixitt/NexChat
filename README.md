...
🌍 Language Exchange Platform – Users can connect and chat across 32 unique DaisyUI themes
⚡ Modern Tech Stack – Built with React, Express, MongoDB, TailwindCSS, TanStack Query
🧠 State Management with Zustand – Lightweight & efficient global state solution
🚨 Robust Error Handling – Frontend & backend level validations
